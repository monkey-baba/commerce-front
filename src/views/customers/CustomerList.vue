        ...
        <el-row>
          <el-col>
            <el-form-item :label=" '客户编号:' " prop="code">
              <el-input v-model="orderQuery.code" :placeholder="'请输入客户编号'" auto-complete="on"/>
            </el-form-item>
            <el-form-item :label=" '客户姓名:' " prop="code">
              <el-input v-model="orderQuery.code" :placeholder="'请输入客户姓名'" auto-complete="on"/>
            </el-form-item>
            <el-form-item :label=" '手机号:' " prop="code">
              <el-input v-model="orderQuery.code" :placeholder="'请输入手机号'" auto-complete="on"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
