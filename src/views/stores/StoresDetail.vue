<template>
  ...
  <div class="app-container">
    <span style=""><strong>门店信息</strong></span>
    <hr>
    <div class="filter-container">
      <ElForm ref="storedetail" :model="storedetail" :inline="true">
        <ElRow>
          <ElCol>
            <ElFormItem :label=" $t('store.code.code')+':' " prop="code" class="code">
              <ElInput v-model="storedetail.code" readonly="true" size="medium" style="width:500px;"/>
            </ElFormItem>
            <ElFormItem :label=" $t('store.name.name')+':' " prop="name" class="name">
        ...
        <ElRow>
          <ElCol>
            <ElFormItem label=" 门店分类:" prop="classifyId" class="classifyId">
              <ElInput v-model="storedetail.classifyId" readonly="true" size="medium" style="width:500px;"/>
            </ElFormItem>
            <ElFormItem label=" 门店状态:" prop="pstatus" class="pstatus">
        ...
        <ElRow>
          <ElCol>
            <ElFormItem label="门店地址:" prop="address" class="address">
...
<script>
import { getStoresDetail } from '@/api/store'
